...
namespace ImGui
{
	...
	IMGUI_API bool          GroupBox(const char* str_id, const char* label, const ImVec2& size_arg, bool border, ImGuiWindowFlags extra_flags);
...
enum ImGuiColorEditFlags_
{
	...
	ImGuiColorEditFlags_NoColorSquare	= 1 << 20,   // ColorEdit: Disable colored square
	ImGuiColorEditFlags_NoSliders		= 1 << 21,   // ColorPicker: Disable RGB/HSV/HEX sliders
	...
	ImGuiColorEditFlags_ModeMask_ = ImGuiColorEditFlags_RGB | ImGuiColorEditFlags_HSV | ImGuiColorEditFlags_HEX // Change application default using SetColorEditOptions()
};
